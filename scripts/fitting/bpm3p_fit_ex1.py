...
data_10m = DataManager.load_data('data\\11_agg_10m.csv')
data_1h = DataManager.load_data('data\\11_agg_1h.csv')
data_1d = DataManager.load_data('data\\11_agg_1d.csv')
...
fit_10m = Fitter.fit_model(data_10m, fitter_model, start=1, end=-1, p0=(1, 10000, 1))
params_10m = fit_10m.get_params()
model_10m = BPM3pProcess(*params_10m)

fit_1h = Fitter.fit_model(data_1h, fitter_model, start=1, end=-1, p0=(3000, 10000, 3000))
params_1h = fit_1h.get_params()
model_1h = BPM3pProcess(*params_1h)

fit_1d = Fitter.fit_model(data_1d, fitter_model, start=1, end=-1, p0=(3000, 10000, 3000))
