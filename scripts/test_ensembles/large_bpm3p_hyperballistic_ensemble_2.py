...
# Save
np.savez_compressed('../../test/test_data/test_ensemble_hyperballistic_2.npz', ensemble=ensemble)

# Load
# with np.load('../../test/test_data/test_ensemble_hyperballistic_2.npz') as loaded_data:
