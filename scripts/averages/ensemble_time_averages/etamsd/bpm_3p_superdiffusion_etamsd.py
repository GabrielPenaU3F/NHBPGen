...
ax.loglog(delta_axis, etamsd_delta, linestyle='-', label='ETAMSD', color='#000681', linewidth=2.5)
ax.loglog(delta_axis[10:], y_regresline[10:], linestyle='--', label='Regression line', color='#E71700', linewidth=2.0)
ax.set_xlabel('Time lag (Δ)', fontsize=22)
ax.xaxis.set_tick_params(labelsize=18)
ax.xaxis.labelpad = 4
ax.set_xlim(auto=True)
ax.set_ylabel('ETAMSD', fontsize=22)
