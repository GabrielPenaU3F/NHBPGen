...
# avgs_t_1 = averager.average_as_function_of_t(ensemble, min_T, max_T, 1, time_step, average_type='sq')
# avgs_t_2 = averager.average_as_function_of_t(ensemble, min_T, max_T, 2, time_step, average_type='sq')
# avgs_t_5 = averager.average_as_function_of_t(ensemble, min_T, max_T, 5, time_step, average_type='sq')
# avgs_t_10 = averager.average_as_function_of_t(ensemble, min_T, max_T, 10, time_step, average_type='sq')
#
