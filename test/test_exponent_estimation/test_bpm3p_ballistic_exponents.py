...
class BPM3pBallisticExponentsTest(unittest.TestCase):
    ...
    def test_moses_exponent_must_be_one_half_for_polya_process(self):
        ...
        delta = 50
        time_step = 1
        moses = BPM3pBallisticExponentsTest.et_averager.estimate_moses(BPM3pBallisticExponentsTest.ballistic_data, min_T, max_T, delta, time_step)
        testing.assert_almost_equal(moses, 1/2, decimal=3)
